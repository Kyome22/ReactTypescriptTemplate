...
- [Qiita API v2の仕様](https://qiita.com/api/v2/docs)

# 1. Qiita側の準備
Qiitaの設定ページへ行き，新規にアプリケーションを登録して，Client IDとClient Secretを入手します．
リダイレクト先のURLは`[任意の文字列] + ://oauth-callback`にして，メモしておきます．
![qiita.png](./images/e9ae70e0-1426-60d5-5296-6d8bb27a4273.png)

# 2. プロジェクトの下準備
URL Typeを追加します．URL Schemesに先ほどのリダイレクト先の任意の文字列を入力します．
![スクリーンショット 2020-01-15 17.02.10.png](./images/b66d17a8-748c-2520-8ff3-e51ad7042704.png)
...
# 参考
[Qiita APIのOAuth認証は一筋縄ではいかない](https://qiita.com/takumi-n/items/795e7687db988dc9e2e5)
